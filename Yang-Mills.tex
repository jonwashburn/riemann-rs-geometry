...
\begin{itemize}
  ...
  \item \textbf{(U2/NRC)} AF--free NRC uniqueness/identification of the continuum generator (Theorem~\ref{thm:U2-nrc-unique}, with the quantitative defect/projector inputs it invokes);
...
\[
  R_{a,L}(z)-R_{a,L}(w)\ =\ (w-z)\,R_{a,L}(z)\,R_{a,L}(w).
\]
...
\[
  \big(I+\delta\,R(z_0)\big)^{-1}\ =\ I+(z_0-z)\,R(z),\qquad
  \big(I+\delta\,R_{a,L}(z_0)\big)^{-1}\ =\ I+(z_0-z)\,R_{a,L}(z),
\]
so
\[
