...
\begin{itemize}
    ...
    \emph{Lean module inventory (14 files):}
    \texttt{Defs}, \texttt{Lagarias}, \texttt{Li}, \texttt{MainRoute3}, \texttt{MathlibBridge}, \texttt{MulConvolution}, \texttt{Concrete}, \texttt{WFunctionals}, \texttt{WeilPositivityRH}, \texttt{Cayley}, \texttt{CayleyBridge}, \texttt{ArithmeticJ}, \texttt{WeilTestFunction}, \texttt{WeilFunctionals}.
